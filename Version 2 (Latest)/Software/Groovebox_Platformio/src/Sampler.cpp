...
void Sampler::init() {
  ...
  * Memory
  */
  byte FLASHCHIP_CS_PIN = 6;
  byte SDCARD_MOSI_PIN = 11;  
  byte SDCARD_SCK_PIN = 13;
...
void Sampler::updateSampleEnvelope(byte sampleNum) {
